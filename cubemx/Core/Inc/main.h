...
#define CH1_HEATER_Pin GPIO_PIN_0
#define CH1_HEATER_GPIO_Port GPIOA
#define CH2_HEATER_Pin GPIO_PIN_1
#define CH2_HEATER_GPIO_Port GPIOA
#define CH1_THERMO_Pin GPIO_PIN_2
#define CH1_THERMO_GPIO_Port GPIOA
#define CH1_CURRENT_Pin GPIO_PIN_3
#define CH1_CURRENT_GPIO_Port GPIOA
#define CH2_THERMO_Pin GPIO_PIN_4
#define CH2_THERMO_GPIO_Port GPIOA
#define CH2_CURRENT_Pin GPIO_PIN_5
#define CH2_CURRENT_GPIO_Port GPIOA
#define CH1_TILT_Pin GPIO_PIN_6
#define CH1_TILT_GPIO_Port GPIOA
#define CH2_TILT_Pin GPIO_PIN_7
